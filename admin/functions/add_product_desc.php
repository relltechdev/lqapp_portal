...
try{
	...
	$query="INSERT into lq_product_description SET product_id='$proid',language_id='$lang',name='$pro_name',description='$desc'";
    ...
    if($result) 
	           {
				  ...
				  mysqli_close($dbConn);
				 $json['status']='success';
	             $json['message']='Product Description added Successfully';
