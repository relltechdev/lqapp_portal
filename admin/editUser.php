          ...
          <div class="">
              ...
              <div class="pull-right">
                <div class="col-md-5 col-sm-5 col-xs-12">
                  <div class="form-group">
                     ...
                     <a href="manageUser.php" style="border: 1px solid #172d44;border-radius: 0px;background: #3f5367; " data-toggle="tooltip" data-original-title="Back" id="viewbtn" class="btn btn-primary viewbtn"> <i class="fa fa-reply"></i> back</a>
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                  <div class="form-group">
                     ...
                     <a href="addUser.php" style="border: 1px solid #4CAF50;border-radius: 0px;background: #4CAF50; " data-toggle="tooltip" data-original-title="Add User" id="viewbtn" class="btn btn-primary viewbtn"> <i class="fa fa-plus"></i></a>
		   ...
		   <!-- tab panel starts -->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Edit User Data</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <!-- tab panel begins-->
                     ...
                     <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Others</a>
                      ...
                      <form id="update_user" action="" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <input type="text"  name="lastname"  class="form-control col-md-7 col-xs-12" value="<?php echo $last_name; ?>">
					  ...
					  <input type="hidden" id="usergroup_id" value="<?php echo $usergroup; ?>" />
                      </div>
					  </div>
                      <div class="form-group">
