 ...
 <!-- page content -->
	...
	<div class="box-header with-border">
            ...
            <a href="addBanner.php" class="btn btn-primary pull-right" style="margin-right:5px;"  data-toggle="tooltip" title="Add Banner">
		...
		<form id="form-user" enctype="multipart/form-data"  action="">
		  ...
		  <thead>
            ...
            <tbody>
				<?php
					$sql="SELECT b.banner_id,b.name,l.name as language,b.image,b.status FROM  lq_banner b LEFT JOIN lq_language l ON (b.language_id=l.language_id) ORDER BY b.banner_id";
					$result=mysqli_query($dbConn,$sql);
					if($result){
						while($row=mysqli_fetch_array($result)){
							echo '<tr>';
							echo '<td><input type="checkbox" value="'.$row['banner_id'].'" name="selected[]"></td>';
						...
						//echo $dirname.'<br>';
							...
							if($row['status']==1)
								...
								echo '<td>Disabled</td>';
							echo '<td style="text-align:right"><a class="btn btn-primary" href="editBanner.php?id='.$row['banner_id'].'&type=edit"><i class="fa fa-fw fa-edit"></i>Edit</a></td>';
							echo '</tr>';
						}
						mysqli_close($dbConn);
					}
