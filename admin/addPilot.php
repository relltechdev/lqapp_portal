...
$dsrc='images/cache/no_image.png';
 ...
 <!-- page content -->
          ...
          <div class="">
              ...
              <div class="title_left">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                  <div class="form-group">
                     <a href="managePilot.php" style="border: 1px solid #172d44;border-radius: 0px;background: #3f5367; "  id="viewbtn" class="btn btn-primary viewbtn"> <i class="fa fa-eye"></i> Pilot List</a>
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                  <div class="form-group">
                     ...
                     <a href="addPilot.php" style="border: 1px solid #4CAF50;border-radius: 0px;background: #4CAF50; " data-toggle="tooltip" data-original-title="Add pilot" id="viewbtn" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New</a>
		   ...
		   <!-- tab panel starts -->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Add New Pilot</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <form id="add_pilot" action="" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <input type="email"  name="email" required="required" class="form-control col-md-7 col-xs-12 emailcheck" >
                      ...
                      <button type="button" class="btn btn-success save_pilotbtn">ADD</button>
                      </div>
                      </div>
		...
		$('.emailcheck').on('keyup',function(e) {
			...
			if(number!="")
			{
			formValidator(number,"pilot","email","emailcheck");
			}
